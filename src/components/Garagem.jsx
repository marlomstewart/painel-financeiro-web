...
export function Garagem({ getHeaders, setTelaAtiva, transacoes, ModalComponent, modalConfig, modalClose, garagem }) {
        ...
        return (
            <div className="p-4 md:p-6 space-y-6 w-full max-w-7xl mx-auto pb-24 relative animate-fade-in">
                ...
                <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 md:p-6 rounded-xl shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-colors">
                    ...
                    <div className="w-full md:w-auto shrink-0 flex flex-col sm:flex-row items-center justify-start sm:justify-end gap-3">
                        <button type="button" onClick={() => setTelaAtiva('dashboard')} className="w-full sm:w-auto bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 font-bold py-2.5 px-4 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 text-sm transition-colors cursor-pointer shadow-sm border border-transparent dark:border-slate-700">
                            ← Voltar
                        </button>
    ...
    return (
        <div className="p-4 md:p-6 space-y-6 w-full max-w-7xl mx-auto pb-24 relative animate-fade-in">
            ...
            {/* 🌟 CABEÇALHO PADRÃO (SÓLIDO E ROLÁVEL) - VISÃO DASHBOARD VEÍCULO */}
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 md:p-6 rounded-xl shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-colors">
                <div className="flex items-center gap-3">
                    <button type="button" onClick={() => setVeiculoSelecionado(null)} className="w-10 h-10 flex items-center justify-center bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-full hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors cursor-pointer text-lg font-bold shadow-inner">←</button>
                    <div>
                        <h1 className="text-xl md:text-2xl font-black text-slate-800 dark:text-slate-100 flex items-center gap-2">
                ...
                <div className="w-full md:w-auto shrink-0 flex flex-col sm:flex-row items-center justify-end gap-2">
