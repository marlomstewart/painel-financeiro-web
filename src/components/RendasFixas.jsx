        ...
        <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto pb-24 animate-fade-in relative">
            <div className="sticky top-0 z-40 pt-4 md:pt-6 pb-2 -mt-4 md:-mt-6 bg-slate-50/90 dark:bg-slate-900/90 backdrop-blur-md mb-6">
                <div className="border-b border-slate-200 dark:border-slate-800 pb-4">
                    <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2">💰 Rendas Fixas</h2>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Automatize entradas recorrentes de caixa (Salário, Mesada, Pensão).</p>
                </div>
            </div>
