...
function App() {
  ...
  const renderizarConteudoAtivo = () => {
    ...
    if (telaAtiva === 'cobrancas') return <Cobrancas transacoes={transacoes} dividas={setup.dividas} cartoes={setup.cartoes} dataVis={dataVis} marcarRecebidoTerceiro={transacoesManager.marcarRecebidoTerceiro} modal={modal} showToast={showToast} chavePix={auth.chavePix} />;
