...
import { instalarRecargaPorPreloadDoVite, recarregarPorChunkDesatualizado } from './utils/pwaUpdate.js'
 ...
 */
const TelaDeErro = ({ erro }) => {
  useEffect(() => {
    recarregarPorChunkDesatualizado(erro)
  }, [erro])
...
instalarRecargaPorPreloadDoVite()

createRoot(document.getElementById('root')).render(
  <StrictMode>
    <Sentry.ErrorBoundary fallback={({ error }) => <TelaDeErro erro={error} />}>
      <App />
